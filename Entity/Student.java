...
public class Student {
    ...
    public void setLibraryCard(boolean hasCard) {
        this.hasLibraryCard = hasCard;
    }

    @Override
    public String toString() {
        return "[" + studentId + "] " + "Name: " + name + ", Email: " + email + ", Phone: " + phone
                + ", Library Card: " + (hasLibraryCard ? "Yes" : "No");
    }
}
